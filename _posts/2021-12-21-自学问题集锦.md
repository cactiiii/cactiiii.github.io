...
## 特征选择方法主要分哪几类？
* 可以参考这篇[文章](https://mp.weixin.qq.com/s/IhcvJc8HQl_4srfz6jvsKQ)，主要分为过滤器方法，包装器方法以及嵌入式方法

## xtr校准综述型博文
* [链接](https://cloud.tencent.com/developer/article/2195683)
* 这里面有篇文章：Calibrating deep neural networks using focal loss 提到了使用focal loss就能解决校准问题，但是它使用的是CIFAR图像数据集，正样本率很高，显然在推荐的稀疏场景中就不适用了。

## 如何从KL散度出发推导出交叉熵loss？
* [这里](https://zhuanlan.zhihu.com/p/573572151?utm_psn=1791787529650987008)也有提到
